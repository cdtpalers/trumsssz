...
export const LOVE_NOTES: LoveNote[] = [
  ...
  {
    id: '4',
    content: "Never na mauulet yung sa last September monthsaryy😉",
    color: 'bg-sky-50',
  },
  {
    id: '5',
  ...
  {
    id: '6',
    content: "let's see our dreams come true together babyyy",
    color: 'bg-sky-50',
  },
  {
    id: '7',
...
export const PLAYLIST: Song[] = [
  {
    ...
    note: "yung song mo for me🤗 hehe kilig somuch sa AFPCES",
  },
  {
    id: '2',
